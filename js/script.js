const questions = [
    ...
    },
    {
        ...
        options: [
            ...
            { text: "8-band bilan", score: 0 },
            { text: "11-band bilan", score: 0 }
        ]
    },
    {
...
function init() {
    ...
    restartBtn.addEventListener('click', () => {
        ...
        scoreRing.style.strokeDashoffset = 440; // Reset circle
    });
}
